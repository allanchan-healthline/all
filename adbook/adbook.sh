...
then
    ...
    aws s3 sync adbook_${YEAR}_${MONTH} s3://healthline-ad-book/adbook_${YEAR}_${MONTH} --delete
fi
...
then
    ...
    then
        ...
        aws s3 sync adbook_${LASTMONTH_YEAR}_${LASTMONTH_MONTH} s3://healthline-ad-book/adbook_${LASTMONTH_YEAR}_${LASTMONTH_MONTH} --delete
    fi
fi

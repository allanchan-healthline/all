...
month_end_date = start_end_month(date(year, mo, 1))[1]
    
if month_end_date < yesterday_date:  # Month has ended at the time of running
    last_delivery_date = month_end_date 
else:  # Mid-month

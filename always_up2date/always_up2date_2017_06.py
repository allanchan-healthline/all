...
from monthly_setup_2017_06 import *
...
DataFlow.UV_TRACKER_PATH = UV_TRACKER_PATH
...
RunThisTo(last_delivery_date, None, None).update_has_changed_df_dicts()
